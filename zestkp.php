...
if ($ok) {
	...
	$sql.=" having if(osoba_pu=2,abonenci.ZABLOK='T',abonenci.ZABLOK!='T') and (zestwpkpw.IDOPERATOR=osoba_id)";
...
if ($ok) {
	...
	$nag.='<br>    Zestawienie wpłat z KP (operator Nr osoba_id, punkt Nr osoba_pu)';
	...
	$nag=str_replace('osoba_id',$_SESSION['osoba_id'],$nag);
