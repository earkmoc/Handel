...
$zz="Select ID from tabele where NAZWA='abonencisz'";
...
$z="select * from tabele where NAZWA='abonencisz'";
$w=mysql_query($z);
$testphp=$z;
if ($w) {
...
echo '</style>';
echo "\n";
echo '<form id="f2" action="AbonentUwagi.php" method="post">';echo "\n";
...
<input type="submit" id="zapiszsz" value=""/>
</div>
</form>

<table align="left" width="765" height="490" border="1" cellpadding="0" cellspacing="0" bordercolorlight=""#C0C0C0" bordercolordark="#808080">
<tr height="75"><td bgcolor="#FFCF3F"></td></tr>
<tr height="50"><td bgcolor="#EFEFCF"></td></tr>
<tr             ><td bgcolor="#FFFFAF"></td></tr>
<tr height="75"><td bgcolor="#EFEFDF"></td></tr>
</table>
