...
echo '<caption align="left">Znajdź dane w tabeli: '.$tyt;
//echo '  (';
//echo $testphp;
echo '</caption>';
for($j=0;$j<=$mc;$j++) {
...
<?php
echo 'Instrukcja wypełniania pól warunku:<ul>';
echo '<li>puste pole oznacza "to pole nie ma znaczenia dla ustalania warunku pokazywania danych"';
echo '<li>';
echo '<li>wpisanie tekstu do pola "id Ulicy" oznacza "pokaż dane rozpoczynające się od podanego tekstu", więc:';
echo '<li>wpisanie litery "h" pokaże dane o wartościach "H01", "H02" itp.';
echo '<li>';
echo '<li>wpisanie liczby do pola "Nr domu" lub "Nr miesz." oznacza "pokaż dane o wartościach równych podanej liczbie uzupełnionej z lewej zerami do długości pola", więc:';
echo '<li>wpisanie liczby 1 pokaże dane o wartościach "001"';
echo '<li>wpisanie liczby i tekstu "1u" pokaże dane o wartościach "001U"';
echo '<li>';
echo '<li>wpisanie tekstu lub liczby do pola "Uwagi stare" (czasem numer bloku, czasem telefon lub inne notatki) oznacza "pokaż dane rozpoczynające się od podanego tekstu/liczby", więc:';
echo '<li>wpisanie liczby 162 pokaże dane o wartościach 162 jak i 162/56 itp.';
echo '</ul>';
?>
</body>
</html>