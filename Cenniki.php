...
<title>Cenniki<?php for($i=0;$i<80;$i++) {echo '&nbsp;';}?></title>
...
<body bgcolor="#EFEFCF" onload="formularz.cennik.select();formularz.cennik.focus();" >

<form id="formularz" action="CennikiZapisz.php" method="post">
Podaj nowy cennik: <input name="cennik" type="text" size="2" value="0" />
