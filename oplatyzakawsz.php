...
//zak³adanie op³at pojedynczego abonenta z tabeli "abonencisz"
...
$z="Select ID from tabele where NAZWA='abonencisz'";		//operacja tylko z tabeli "abonencisz"
...
$w=mysql_query($z);
//mysql_query("truncate zdania");
//mysql_query("insert into zdania set zdanie='".AddSlashes($z)."'");
...
//mysql_query("insert into zdania set zdanie='$a'");
...
//mysql_query("insert into zdania set zdanie='$a  $b'");
