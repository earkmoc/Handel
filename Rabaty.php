...
<title>Rabaty<?php for($i=0;$i<80;$i++) {echo '&nbsp;';}?></title>
...
<body bgcolor="#EFEFCF" onload="formularz.rabat.select();formularz.rabat.focus();" >

<form id="formularz" action="RabatyZapisz.php" method="post">
Podaj nowy rabat: <input name="rabat" type="text" size="2" value="0" />
